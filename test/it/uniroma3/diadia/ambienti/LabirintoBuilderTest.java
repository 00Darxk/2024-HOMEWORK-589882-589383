...
public class LabirintoBuilderTest {
	...
	public void testMonolocaleConAttrezzoSingoloDuplicato() {
		...
		assertTrue(size==1);
		assertTrue(monolocale.getStanzaIniziale().getAttrezzi().contains(new Attrezzo("spada",1)));
	}
	...
	public void testBilocale() {
		...
		assertTrue(bilocale.getStanzaIniziale().getDirezioni().containsAll(Arrays.asList(Direzione.NORD)));
		assertTrue(bilocale.getStanzaVincente().getDirezioni().containsAll(Arrays.asList(Direzione.SUD)));
	}
	...
	public void testLabirintoCompletoConTutteLeStanze() {
		...
		List<Attrezzo> attrezzi = new ArrayList<>();
		attrezzi.addAll(corridoio.getAttrezzi());
		assertEquals(Arrays.asList(a1,a2),attrezzi);
