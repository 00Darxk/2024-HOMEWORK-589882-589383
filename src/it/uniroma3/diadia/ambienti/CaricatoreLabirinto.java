...
public class CaricatoreLabirinto {
	...
	public CaricatoreLabirinto(String nomeFile)  throws IOException {
		...
		try(InputStream in = CaricatoreLabirinto.class.getClassLoader().getResourceAsStream(nomeFile)){
	...
	private void leggiECreaStanzeMagiche() throws FormatoFileNonValidoException {
		...
		for(String stanzaMagica : separaStringheAlleVirgole(stanzeMagiche)) {
			...
			else this.labirintoBuilder.addStanzaBuia(nomeStanza, sogliaMagica);
		}
	}
	...
	private void leggiECollocaPersonaggi() throws FormatoFileNonValidoException {
		...
		for(String personaggio : separaStringheAlleVirgole(personaggi)) {
			...
			collacaPersonaggio(nomeStanza, tipoPersonaggio, nomePersonaggio, presentazionePersonaggio, ciboPreferito, nomeAttrezzoInBocca, pesoAttrezzoInBocca);
			

		}
	}

	private void collacaPersonaggio(String nomeStanza, String tipoPersonaggio, String nomePersonaggio, String presentazionePersonaggio, String ciboPreferito, String nomeAttrezzoInBocca, String pesoAttrezzoInBocca) throws FormatoFileNonValidoException{
		int peso;
		try {
			...
			if(tipoPersonaggio.equals("Mago"))
				this.labirintoBuilder.addMago(nomeStanza, nomePersonaggio, presentazionePersonaggio);
				...
				this.labirintoBuilder.addCane(nomeStanza, nomePersonaggio, presentazionePersonaggio, ciboPreferito, nomeAttrezzoInBocca, peso);
			}
			else
